...
var file_proto_types_userpb_v3_user_proto_rawDesc = []byte{
	...
	0x6e, 0x42, 0xeb, 0x01, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e, 0x72, 0x61, 0x66, 0x61, 0x79, 0x2e,
	0x64, 0x65, 0x76, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76,
	0x33, 0x42, 0x09, 0x55, 0x73, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x40,
...
var file_proto_types_userpb_v3_user_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_types_userpb_v3_user_proto_goTypes = []interface{}{
	...
	(*UserRole)(nil),             // 3: rafay.dev.types.user.v3.UserRole
	(*v3.Metadata)(nil),          // 4: rafay.dev.types.common.v3.Metadata
	(*v3.Status)(nil),            // 5: rafay.dev.types.common.v3.Status
	(*ProjectNamespaceRole)(nil), // 6: rafay.dev.types.user.v3.ProjectNamespaceRole
	(*v3.ListMetadata)(nil),      // 7: rafay.dev.types.common.v3.ListMetadata
}
var file_proto_types_userpb_v3_user_proto_depIdxs = []int32{
	4, // 0: rafay.dev.types.user.v3.User.metadata:type_name -> rafay.dev.types.common.v3.Metadata
	1, // 1: rafay.dev.types.user.v3.User.spec:type_name -> rafay.dev.types.user.v3.UserSpec
	5, // 2: rafay.dev.types.user.v3.User.status:type_name -> rafay.dev.types.common.v3.Status
	6, // 3: rafay.dev.types.user.v3.UserSpec.projectNamespaceRoles:type_name -> rafay.dev.types.user.v3.ProjectNamespaceRole
	7, // 4: rafay.dev.types.user.v3.UserList.metadata:type_name -> rafay.dev.types.common.v3.ListMetadata
