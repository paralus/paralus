...
CREATE SEQUENCE IF NOT EXISTS authsrv_accountresourcerole_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE authsrv_accountresourcerole_id_seq OWNER TO admindbuser;

ALTER SEQUENCE authsrv_accountresourcerole_id_seq OWNED BY authsrv_accountresourcerole.id;

ALTER TABLE ONLY authsrv_accountresourcerole ALTER COLUMN id SET DEFAULT nextval('authsrv_accountresourcerole_id_seq'::regclass);
