...
require github.com/uptrace/bun/extra/bundebug v1.0.20
...
require github.com/processout/grpc-go-pool v1.2.1

require sigs.k8s.io/controller-runtime v0.11.1
...
require github.com/casbin/gorm-adapter/v3 v3.4.6
