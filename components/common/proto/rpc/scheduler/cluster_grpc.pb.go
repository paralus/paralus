...
type ClusterClient interface {
	...
	UpdateClusterStatus(ctx context.Context, in *v3.Cluster, opts ...grpc.CallOption) (*v3.Cluster, error)
}
...
type ClusterServer interface {
	...
	UpdateClusterStatus(context.Context, *v3.Cluster) (*v3.Cluster, error)
}
...
func (UnimplementedClusterServer) RegisterCluster(context.Context, *RegisterClusterRequest) (*RegisterClusterResponse, error) {
...
func (UnimplementedClusterServer) UpdateClusterStatus(context.Context, *v3.Cluster) (*v3.Cluster, error) {
...
func _Cluster_RegisterCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterClusterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClusterServer).RegisterCluster(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _Cluster_UpdateClusterStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v3.Cluster)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClusterServer).UpdateClusterStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var Cluster_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Cluster_RegisterCluster_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _Cluster_UpdateClusterStatus_Handler,
		},
	},
