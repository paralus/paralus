...
func (m *V1SecretProjection) validateLocalObjectReference(formats strfmt.Registry) error {
...
func (m *V1SecretProjection) contextValidateLocalObjectReference(ctx context.Context, formats strfmt.Registry) error {
